...
import java.math.*;
 ...
 /**
  * Miembro Data Access Object (DAO).
  * This class contains all database handling that is needed to 
  * permanently store and retrieve Miembro object instances. 
  */
...
public class MiembroDAO {
     ...
     * clone() method in it!
     */
    public Miembro createValueObject() {
          return new Miembro();
    }
     ...
     */
    public Miembro getObject(Connection conn, int cedula) throws NotFoundException, SQLException {

          Miembro valueObject = createValueObject();
     ...
     */
    public synchronized void create(Connection conn, Miembro valueObject) throws SQLException {
     ...
     */
    public List searchMatching(Connection conn, Miembro valueObject) throws SQLException {
     ...
     */
    protected void singleQuery(Connection conn, PreparedStatement stmt, Miembro valueObject) 
          throws NotFoundException, SQLException {
          ...
          try {
              ...
              if (result.next()) {
                   ...
                   valueObject.setPuntos(result.getInt("6")); 
                    ...
                    throw new NotFoundException("Miembro Object Not Found!");
              }
          } finally {
              if (result != null)
                  result.close();
