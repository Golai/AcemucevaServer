...
import java.math.*;
 ...
 /**
  * Login Data Access Object (DAO).
  * This class contains all database handling that is needed to 
  * permanently store and retrieve Login object instances. 
  */
...
public class LoginDAO {
     ...
     */
    public Login getObject(Connection conn, int id_usuario) throws NotFoundException, SQLException {

          Login valueObject = createValueObject();
     ...
     */
    public synchronized void create(Connection conn, Login valueObject) throws SQLException {
          ...
          try {
               ...
               stmt.setInt(5, valueObject.getCelular()); 
     ...
     *                     Primary-key field must be set for this to work properly.
     */
    public void save(Connection conn, Login valueObject) 
     ...
     *                     Primary-key field must be set for this to work properly.
     */
    public void delete(Connection conn, Login valueObject) 
          throws NotFoundException, SQLException {
    ...
    public List searchMatching(Connection conn, Login valueObject) throws SQLException {
          ...
          if (valueObject.getId_usuario() != 0) {
              ...
              sql.append("AND 1 = ").append(valueObject.getId_usuario()).append(" ");
          }
          ...
          if (valueObject.getPassword() != null) {
              if (first) { first = false; }
              sql.append("AND 3 LIKE '").append(valueObject.getPassword()).append("%' ");
          }
          ...
          if (valueObject.getCelular() != 0) {
              if (first) { first = false; }
              sql.append("AND 5 = ").append(valueObject.getCelular()).append(" ");
          }
     ...
     */
    protected void singleQuery(Connection conn, PreparedStatement stmt, Login valueObject) 
          throws NotFoundException, SQLException {
          ...
          try {
              ...
              if (result.next()) {
                   ...
                   valueObject.setId_usuario(result.getInt("1")); 
                   valueObject.setNombre(result.getString("2")); 
                   valueObject.setPassword(result.getString("3")); 
                   valueObject.setEmail(result.getString("4")); 
                   valueObject.setCelular(result.getInt("5")); 

              } else {
                    //System.out.println("Login Object Not Found!");
                    throw new NotFoundException("Login Object Not Found!");
              }
          } finally {
              if (result != null)
                  result.close();
