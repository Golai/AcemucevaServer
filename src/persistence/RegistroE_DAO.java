...
import java.math.*;
 ...
 /**
  * RegistroE Data Access Object (DAO).
  * This class contains all database handling that is needed to 
  * permanently store and retrieve RegistroE object instances. 
  */
...
public class RegistroE_DAO {
     ...
     * clone() method in it!
     */
    public RegistroE createValueObject() {
     ...
     */
    public RegistroE getObject(Connection conn, int id_registro) throws NotFoundException, SQLException {

          RegistroE valueObject = createValueObject();
          valueObject.setId_registro(id_registro);
     ...
     */
    public synchronized void create(Connection conn, RegistroE valueObject) throws SQLException {
     ...
     */
    public List searchMatching(Connection conn, RegistroE valueObject) throws SQLException {
     ...
     */
    protected void singleQuery(Connection conn, PreparedStatement stmt, RegistroE valueObject) 
          throws NotFoundException, SQLException {
          ...
          try {
              ...
              if (result.next()) {
                   ...
                   valueObject.setAsistencia(result.getString("6")); 
                    ...
                    throw new NotFoundException("RegistroE Object Not Found!");
              }
          } finally {
              if (result != null)
                  result.close();
