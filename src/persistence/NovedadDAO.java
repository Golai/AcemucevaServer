...
import java.math.*;
 ...
 /**
  * Novedad Data Access Object (DAO).
  * This class contains all database handling that is needed to 
  * permanently store and retrieve Novedad object instances. 
  */
...
public class NovedadDAO {
     ...
     * clone() method in it!
     */
    public Novedad createValueObject() {
          return new Novedad();
    }
     ...
     */
    public Novedad getObject(Connection conn, int id_novedades) throws NotFoundException, SQLException {

          Novedad valueObject = createValueObject();
          valueObject.setId_novedades(id_novedades);
     ...
     */
    public synchronized void create(Connection conn, Novedad valueObject) throws SQLException {
          ...
          try {
               ...
               stmt.setInt(3, valueObject.getId_encargado()); 
               stmt.setString(4, valueObject.getDescripcion()); 
               stmt.setString(5, valueObject.getTipo_novedad()); 
    ...
    public void save(Connection conn, Novedad valueObject) 
          ...
          try {
              ...
              stmt.setInt(5, valueObject.getId_novedades()); 
     ...
     */
    public List searchMatching(Connection conn, Novedad valueObject) throws SQLException {
     ...
     */
    protected void singleQuery(Connection conn, PreparedStatement stmt, Novedad valueObject) 
          throws NotFoundException, SQLException {
          ...
          try {
              ...
              if (result.next()) {
                   ...
                   valueObject.setTipo_novedad(result.getString("5")); 
                    ...
                    throw new NotFoundException("Novedad Object Not Found!");
              }
          } finally {
              if (result != null)
                  result.close();
