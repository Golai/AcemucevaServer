...
import java.math.*;
 ...
 /**
  * Evento Data Access Object (DAO).
  * This class contains all database handling that is needed to 
  * permanently store and retrieve Evento object instances. 
  */
...
public class EventoDAO {
     ...
     * clone() method in it!
     */
    public Evento createValueObject() {
          return new Evento();
    }
     ...
     */
    public Evento getObject(Connection conn, int id_evento) throws NotFoundException, SQLException {

          Evento valueObject = createValueObject();
          valueObject.setId_evento(id_evento);
     ...
     */
    public synchronized void create(Connection conn, Evento valueObject) throws SQLException {
          ...
          try {
               ...
               stmt.setString(3, valueObject.getNombre_evento()); 
    ...
    public void save(Connection conn, Evento valueObject) 
          ...
          try {
              ...
              stmt.setString(2, valueObject.getNombre_evento()); 
              ...
              stmt.setInt(10, valueObject.getId_evento()); 
     ...
     */
    public List searchMatching(Connection conn, Evento valueObject) throws SQLException {
          ...
          if (valueObject.getId_evento() != 0) {
              ...
              sql.append("AND 1 = ").append(valueObject.getId_evento()).append(" ");
          }

          if (valueObject.getId_encargado() != 0) {
              if (first) { first = false; }
              sql.append("AND 2 = ").append(valueObject.getId_encargado()).append(" ");
          }

          if (valueObject.getNombre_evento() != null) {
              if (first) { first = false; }
              sql.append("AND 3 LIKE '").append(valueObject.getNombre_evento()).append("%' ");
          }
          ...
          if (valueObject.getFecha() != null) {
              if (first) { first = false; }
              sql.append("AND 5 = '").append(valueObject.getFecha()).append("' ");
          }
          ...
          if (valueObject.getCupos() != 0) {
              if (first) { first = false; }
              sql.append("AND 8 = ").append(valueObject.getCupos()).append(" ");
          }

          if (valueObject.getPuntos() != 0) {
              if (first) { first = false; }
              sql.append("AND 9 = ").append(valueObject.getPuntos()).append(" ");
          }

          if (valueObject.getTipo_evento() != null) {
              if (first) { first = false; }
              sql.append("AND 10 LIKE '").append(valueObject.getTipo_evento()).append("%' ");
          }
     ...
     */
    protected void singleQuery(Connection conn, PreparedStatement stmt, Evento valueObject) 
          throws NotFoundException, SQLException {
          ...
          try {
              ...
              if (result.next()) {
                   ...
                   valueObject.setTipo_evento(result.getString("10")); 
                    ...
                    throw new NotFoundException("Evento Object Not Found!");
              }
          } finally {
              if (result != null)
                  result.close();
