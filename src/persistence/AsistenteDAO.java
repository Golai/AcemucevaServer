...
import java.math.*;
 ...
 /**
  * Asistente Data Access Object (DAO).
  * This class contains all database handling that is needed to 
  * permanently store and retrieve Asistente object instances. 
  */
...
public class AsistenteDAO {
     ...
     * clone() method in it!
     */
    public Asistente createValueObject() {
     ...
     */
    public Asistente getObject(Connection conn, int cedula) throws NotFoundException, SQLException {

          Asistente valueObject = createValueObject();
     ...
     */
    public synchronized void create(Connection conn, Asistente valueObject) throws SQLException {
    ...
    public void save(Connection conn, Asistente valueObject) 
          ...
          try {
              ...
              stmt.setInt(2, valueObject.getCelular()); 
     ...
     */
    public List searchMatching(Connection conn, Asistente valueObject) throws SQLException {
     ...
     */
    protected void singleQuery(Connection conn, PreparedStatement stmt, Asistente valueObject) 
          throws NotFoundException, SQLException {
          ...
          try {
              ...
              if (result.next()) {
                   ...
                   valueObject.setEmail(result.getString("4")); 
                    ...
                    throw new NotFoundException("Asistente Object Not Found!");
              }
          } finally {
              if (result != null)
                  result.close();
